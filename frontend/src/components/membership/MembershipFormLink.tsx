...
const available=["gnpc-btn","group","inline-flex","max-w-full","min-h-11","items-center","justify-center","gap-2","whitespace-nowrap","rounded-xl","border","border-[#155eef]","bg-[#155eef]","px-5","py-3","text-sm","font-bold","leading-none","text-white","shadow-[0_6px_18px_rgba(21,94,239,0.18)]","transition-all","duration-200","hover:-translate-y-0.5","hover:border-[#004eeb]","hover:bg-[#004eeb]","focus-visible:outline-none","focus-visible:ring-2","focus-visible:ring-[#155eef]","focus-visible:ring-offset-2","[&_svg]:shrink-0","[&_svg]:transition-transform","[&_svg]:duration-200","hover:[&_svg]:translate-x-0.5"].join(" ");
const unavailable=["gnpc-btn","inline-flex","max-w-full","min-h-11","items-center","justify-center","gap-2","whitespace-nowrap","rounded-xl","border","border-slate-300","bg-slate-100","px-5","py-3","text-sm","font-bold","leading-none","text-slate-500","opacity-70"].join(" ");
