...
export default function About() {
  ...
  return <section id="about" className="bg-white py-14 sm:py-20 lg:py-24"><div className="mx-auto max-w-7xl px-4 sm:px-6"><div className="mb-9 text-center sm:mb-14"><span className="rounded-full bg-blue-100 px-3 py-1.5 text-xs font-semibold text-blue-700 sm:px-4 sm:py-2 sm:text-sm">About Us</span><h2 className="mt-4 text-3xl font-extrabold text-slate-900 sm:mt-5 sm:text-4xl md:text-5xl">{settings.siteName || "Press Club"}</h2></div>
